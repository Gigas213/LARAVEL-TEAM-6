      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link " href="{{ route('tambah_product') }}">
                <i class="ni ni-circle-08 text-pink"></i>
                <span class="nav-link-text">Tambah Product</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('daftar_product') }}">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edit Profilex</h6>
      ...
      <div class="row">
        ...
        <div class="table-responsive">
          @if(Session::get('success'))
              <div class="alert alert-success alert-dismissible fade show col-11 mx-auto" role="alert">
                {{ Session::get('success') }}
        ...
        <table class="table align-items-center table-flush">
          ...
          <tbody class="list">
            ...
            <tr>
                ...
                <td>
                  <a href={{ "edit/".$product->id }} class="btn btn-sm btn-danger">EDIT</a>
